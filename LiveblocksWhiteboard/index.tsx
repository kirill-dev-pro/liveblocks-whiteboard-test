      ...
      <div className={styles.canvas}>
        {selectionBounds && (
          <SelectionTools
            ...
            y={(selectionBounds.y + camera.y) * camera.zoom}
            setFill={setFill}
        ...
        <svg
          ...
          onWheel={e => {
            ...
            setCamera(camera => ({
              ...camera,
              // x: MinMax(camera.x - e.deltaX, -1000, 1000),
              // y: MinMax(camera.y - e.deltaY, -100, 100),
              zoom: MinMax(camera.zoom + e.deltaY / 100, 0.1, 2),
            }))
          }}
          onPointerDown={e => {
            const point = pointerEventToCanvasPoint(e, camera)
